...
class QRedshift extends Applet.TextIconApplet {
    ...
    onKeyChanged() {
        ...
        Main.keybindingManager.addHotKey("keyBrightnessUp", this.opt.keyBrightnessUp, (event) => {
            const STEP = 10 // couldn't find this step anywhere in the code
            let newValuedb = this.db_Slider.value + STEP;
            let newValuenb = this.nb_Slider.value + STEP;

            this.db_Slider._setValueEmit(newValuedb);
            this.nb_Slider._setValueEmit(newValuenb);
            // this.doUpdate(); Slow when pressing keybind several times. I didn't notice any difference with this line commented out.
        });
        ...
        Main.keybindingManager.addHotKey("keyBrightnessDown", this.opt.keyBrightnessDown, (event) => {
            ...
            this.db_Slider._setValueEmit(newValuedb);
            this.nb_Slider._setValueEmit(newValuenb);
            // this.doUpdate(); Slow when pressing several keybind times. I didn't notice any difference with this line commented out.
        });
